  ...
  return (
    <div id="projects" className="projects" ref={props.ref}>
      ...
      <ProjectCard
        id="0"
        name="Quizzical"
        desc="It was my first project, I built after learning React. It is a quiz website in which basics of react such as conditional rendering, use of hooks like useState and useEffect are used."
        image1={img1}
        image2={img2}
        image3={img3}
